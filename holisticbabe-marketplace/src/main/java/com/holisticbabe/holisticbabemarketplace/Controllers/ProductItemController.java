...
public class ProductItemController {
    ...
    @PostMapping
    public ResponseEntity<ProductItem> createProductItem(@RequestParam ("sku") String sku , @RequestParam ("quantityInStock") int quantityInStock, @RequestParam ("price") BigDecimal price, @RequestParam ("idProduct") Long productId, @RequestParam ("variationOptionValues") List<String> variationOptionValues) {
    ...
    public ResponseEntity<ProductItem> updateProductItem(
            ...
            @RequestParam List<String> variationOptionValues) {

        ProductItem updatedItem = productItemService.updateProductItem(productItemId, updatedProductItemRequest, variationOptionValues);
